...
class ProgressionService: # Service class to handle all progression-related business logic, called by server.py after authentication and validation
    ...
    def get_user_data(self, uid: str, email: str = None):
        ...
        return {
            ...
            **self._repo.get_referral_summary(uid),
    ...
    def update_notification_prefs(self, uid: str, prefs: dict):
        self._repo.set_user_settings(uid, prefs)
    ...
    def move_food_log(self, uid: str, food_id: str, meal: str):
        self._repo.move_food_log(uid, food_id, meal)

    def edit_food_log(self, uid: str, food_id: str, fields: dict):
        self._repo.edit_food_log(uid, food_id, fields)

    def bulk_add_food_logs(self, uid: str, items: list) -> list:
        return self._repo.bulk_add_food_logs(uid, items)

    def bulk_delete_food_logs(self, uid: str, ids: list) -> None:
        self._repo.bulk_delete_food_logs(uid, ids)
