...
SERVER_ACHIEVEMENT_IDS = {
    "level", "daily_claims", "poi_visits", "food_logs", "set_reminder",
    "delete_reminder", "set_username", "set_pfp", "change_app_color",
    "color_indecisive", "change_username", "total_achievements",
}
...
TRIVIAL_ACHIEVEMENT_IDS = {
    "daily_consecutive", "poi_categories", "poi_regular",
    "open_food_logging", "open_explore", "open_reminders", "open_badges", "open_leaderboard",
    "food_recent", "food_full_day", "food_streak", "food_manual", "food_barcode",
