...
class _FoodAnalyticsScreenState extends ConsumerState<FoodAnalyticsScreen>
  ...
  Map<String, double> _totalMicros() {
  ...
  Widget _microLineChart(BuildContext context, List<_DayPoint> points) {
    if (points.isEmpty) {
      return frostedGlassCard(
        context,
        color: appColor,
                ...
                builder: (context) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      // MICRO GRAPH
                      sectionHeader("MICRO GRAPH", context, appColor: appColor)
                          .animate(
                            key: ValueKey((
                              'range_micro_graph_title',
                              _rangeAnimationKey,
                            )),
                          )
                      ...
                      _microLineChart(context, points)
                          .animate(
                            key: ValueKey((
                              'range_micro_graph',
                              _rangeAnimationKey,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            sectionHeader("MICRO BREAKDOWN", ctx, appColor: appColor)
                .animate(key: ValueKey(('micros_title', animationKey)))
                .fadeIn(delay: 250.ms, duration: 300.ms)
                .slideY(
                  begin: 0.08,
                  delay: 250.ms,
            ...
            frostedGlassCard(
                  ...
                  child:
                      ...
                      : microBarChart(
                          ...
                          fiberG: micros['fiber']!,
                          sugarG: micros['sugar']!,
                          sodiumMg: micros['sodium']!,
                        ),
                )
                .animate(key: ValueKey(('micros_chart', animationKey)))
                .fadeIn(delay: 300.ms, duration: 300.ms)
                .slideY(
                  begin: 0.08,
                  delay: 300.ms,
