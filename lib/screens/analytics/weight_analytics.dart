    ...
    Widget chip(int i) => GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _chipIndex == i ? accent.withAlpha(40) : accent.withAlpha(10),
        ...
        child: Text(
          ...
          style: GoogleFonts.manrope(
            ...
            fontWeight: _chipIndex == i ? FontWeight.w700 : FontWeight.w500,
            color: _chipIndex == i
                ? accent
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            _formatDateKey(_dateKeyFor(_addDate)),
                            style: GoogleFonts.manrope(
