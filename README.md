...
# Availability
- Currently, **Level Up!** is available at https://nicholasdakis.github.io/level_up/
- It is accessible on both desktop and mobile devices
...
### 6) Leaderboard tab
- Displays the **highest-level** users
...
### Daily XP Reward
- Users can claim an **experience reward** once per day

### Footer Tab
- Displays the user's **current experience points** and **level**
- Shows **profile picture**
- Features a **level progress bar**, showing progress towards the next level
...
- _Note: The tab is also accessible via the footer by tapping the Profile Picture_
